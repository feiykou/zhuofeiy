<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"/data/www/zhuo/public/../application/admin/view/product/index.html";i:1527843269;s:54:"/data/www/zhuo/application/admin/view/public/base.html";i:1526043810;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <table class="table table-inbox table-hover">
                    ...
                    <tbody>
                        ...
                        <tr data-id="<?php echo $data['id']; ?>">
                            ...
                            <td class="view-message"><?php if(empty($data['pname']) || (($data['pname'] instanceof \think\Collection || $data['pname'] instanceof \think\Paginator ) && $data['pname']->isEmpty())): ?>暂无<?php else: ?><?php echo $data['pname']; endif; ?></td>
                            <td class="view-message"><?php echo $data['publisher']; ?></td>
                            <td class="view-message"><span class="btn btn-primary btn-xs mr10 btn-del" data-id="<?php echo $data['id']; ?>" data-toggle="modal" data-target="#del-modal">删除</span> <a href="<?php echo url('edit',['id'=>$data['id']]); ?>" class="btn btn-primary btn-xs">编辑</a></td>
                        </tr>
