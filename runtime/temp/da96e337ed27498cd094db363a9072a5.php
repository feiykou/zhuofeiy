<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"/data/www/zhuo/public/../application/admin/view/article/add.html";i:1527833662;s:54:"/data/www/zhuo/application/admin/view/public/base.html";i:1526043810;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                            ...
                            <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="<?php echo Url('artAdd'); ?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10 radio-item">
                                        ...
                                        <label><input type="radio" style="width: 20px" <?php if($k == 1): ?>checked<?php endif; ?> value="<?php echo $k; ?>" class="radio form-control" name="img_type" /><span><?php echo $imgType; ?></span></label>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </div>
                                </div>
                                <div class="form-group ">
