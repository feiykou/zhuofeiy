<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"/data/www/zhuo/public/../application/admin/view/article/edit.html";i:1527833662;s:54:"/data/www/zhuo/application/admin/view/public/base.html";i:1526043810;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                            ...
                            <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="<?php echo Url('artEditUpdate',['id'=>$artData['id']]); ?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10 radio-item">
                                        <?php if(is_array($imgTypeArr) || $imgTypeArr instanceof \think\Collection || $imgTypeArr instanceof \think\Paginator): $k = 0; $__LIST__ = $imgTypeArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$imgType): $mod = ($k % 2 );++$k;?>
                                        <label><input type="radio" style="width: 20px" <?php if($artData['img_type'] == $k): ?>checked<?php endif; ?> value="<?php echo $k; ?>" class="radio form-control" name="img_type" /><span><?php echo $imgType; ?></span></label>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </div>
                                </div>
                                <div class="form-group ">
